...
local THEME = {
    ...
    ACCENT_BLUE  = Color3.fromRGB(80, 140, 255),
...
local combatBtn, combatPage = createTab("⚔️",  "Combat")
local visualBtn, visualPage = createTab("👁️",  "Visual")
local moveBtn,   movePage   = createTab("🚀",  "Move")
local miscBtn,   miscPage   = createTab("⚙️",  "Misc")

switchTab("Combat", combatBtn)
...
-- ═══════════════════════════════════════════
-- EXPORTS — simpan ke _G supaya features.lua bisa akses
-- ═══════════════════════════════════════════
local exports = {
    THEME         = THEME,
    corner        = corner,
